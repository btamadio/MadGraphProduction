...
if options["runNumber"] not in [343260]:
  raise RuntimeError("runNumber {0:d} not recognised in these jobOptions. Available options are: 343260".format(options["runNumber"]))
...
# Generate_tf.py --ecmEnergy=13000 --firstEvent=1 --randomSeed=1 --jobConfig=MC15.343260.MadGraphPythia8EvtGen_A14NNPDF23LO_vbfhzz4l_0pphkHv2p5.py --outputEVNTFile=EVNT.00001.root --runNumber=343260 --maxEvents=10
#---------------------------------------------------------------------------------------------------
