...
if options["runNumber"] not in [343248]:
  raise RuntimeError("runNumber {0:d} not recognised in these jobOptions. Available options are: 343248".format(options["runNumber"]))
...
writeparamcard(masses={'25': '1.250000e+02'},options=options,parameters={'frblock': {'kAbb': 0.0, 'kHaa': 0.0, 'kAaa': 0.0, 'cosa': 1.0, 'kHdwR': 0.0, 'kAza': 0.0, 'kAll': 0.0, 'kHbb': 0.0, 'kHll': 0.0, 'kAzz': 0.0, 'kSM': 0.0, 'kHdwI': 0.0, 'kHdz': 10, 'kAww': 0.0, 'kAtt': 0.0, 'kHda': 0.0, 'kHza': 0.0, 'kHtt': 0.0, 'kHww': 0.0, 'kHzz': 0.0, 'Lambda': 1000.0}})
...
# Generate_tf.py --ecmEnergy=13000 --firstEvent=1 --randomSeed=1 --jobConfig=MC15.343248.MadGraphPythia8EvtGen_A14NNPDF23LO_vbfhzz4l_0phkHdz10.py --outputEVNTFile=EVNT.00001.root --runNumber=343248 --maxEvents=10
#---------------------------------------------------------------------------------------------------
