...
yx = 1.0 / (Lambda * Lambda)

with open('proc_card_mg5.dat','w') as f:
    f.write("""
import model Higgs_xdxhDh_UFO
...
paramcardname = 'MadGraph_param_card_monoHiggs_xdxhDh.dat'
...
stringy = 'Madgraph.'+str(runArgs.runNumber)+'.xdxhDh.mDM'+str(mDM)
