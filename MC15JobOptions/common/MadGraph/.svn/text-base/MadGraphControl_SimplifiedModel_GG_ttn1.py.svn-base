...
evgenConfig.keywords += ['simplifiedModel', 'gluino', 'neutralino', 'SUSY', 'boosted', 'top']
evgenConfig.description = 'gluino pair production and decay to top pair and LSP via off-shell stop, m_glu = %s GeV, m_stop = %s GeV, m_N1 = %s GeV'%(masses['1000021'],masses['1000006'],masses['1000022'])
