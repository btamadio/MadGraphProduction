...
deltaM = 2
if decaytype.startswith('directGts'):
    deltaM = float(decaytype.replace('directGts',''))
    decaytype = 'directGts'
...
evgenConfig.description = 'gluino production in simplified model with decay to top and 4-body stop decay, m_glu = %s GeV, m_N1 = %s GeV, deltaM = %s Gev'%(masses['1000021'],masses['1000022'],deltaM)
