...
slice_config  = { 0:[0,200,0,150, -1, 100],
                  1:[0,200,150,350, -1, 6000],
                  2:[0,200,350,13000, -1, 60000],
                  3:[200,500,0,150, -1, 200],
                  4:[200,500,150,350, -1, 750],
                  5:[200,500,350,13000, -1, 1800],
                  6:[500,6500,0,150, -1, 10000],
                  7:[500,6500,150,350, -1, 20500],
                  8:[500,6500,350,13000, -1, 18200]}
...
evgenConfig.description    = "POWHEG+Pythia6 ttbar + c-jets production with Powheg hdamp equal top mass, Perugia 2012 tune, at least one lepton filter, additional c-jet filter,  had top pT min = %i GeV, max = %i GeV; ttbar pT min = %i GeV, max = %i GeV; supp factor = %i, at least one AntiKt10Truth jet pT>200 GeV and |eta|<2"%(top_pt_min, top_pt_max, tt_pt_min, tt_pt_max, supp)
evgenConfig.keywords    = [ 'SM', 'top', 'ttbar', 'lepton']
evgenConfig.contact     = ['lily.asquith@cern.ch', 'eloi.paul.le.quilleuc@cern.ch', 'georges.aad@cern.ch' ]
evgenConfig.minevents   = 500

# IC: Check DSID and adjust the minevents for the failing events (426072 and 426077)
if runID == 2 or runID == 7:
...
if runArgs.trfSubstepName == 'generate' :
   ...
   filtSeq.TTbarPlusBFilter.SelectL = False
   ...
   filtSeq.QCDTruthJetFilter.MinPt = 100000. #MeV
