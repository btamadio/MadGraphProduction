...
if runArgs.runNumber == 305104:
    mH=125
    nGamma=2
    avgtau = 856.0
elif runArgs.runNumber == 305105:
    mH = 800
    nGamma = 2
    avgtau = 226.0
elif runArgs.runNumber == 305106:
    mH = 125
    nGamma = 4
    avgtau = 1300.0
elif runArgs.runNumber == 305107:
    mH = 800
    nGamma = 4
    avgtau = 338.0
elif runArgs.runNumber == 305108:
    mH=125
    nGamma=2
elif runArgs.runNumber == 305109:
    mH = 800
    nGamma = 2
elif runArgs.runNumber == 305110:
    mH = 125
    nGamma = 4
elif runArgs.runNumber == 305111:
    mH = 800
    nGamma = 4
if avgtau > 0:
	category = 'displaced'
...
modelcode = 'iDM'
rcard='MadGraph_run_card_FRVZheavy.dat'
