...
paramcard = subprocess.Popen(['get_files','-data','MadGraph_param_card_dmP.dat'])
paramcard.wait()
if not os.access('MadGraph_param_card_dmP.dat',os.R_OK):
    print 'ERROR: Could not get param card'
elif os.access('param_card.dat',os.R_OK):
    print 'ERROR: Old param card in the current directory.  Dont want to clobber it.  Please move it first.'
else:
    oldcard = open('MadGraph_param_card_dmP.dat','r')
...
#### Shower  
evgenConfig.description = "Wimp pair monoZ with dmP"
