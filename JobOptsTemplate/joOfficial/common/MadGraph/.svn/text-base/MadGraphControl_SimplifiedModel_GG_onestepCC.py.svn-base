...
evgenConfig.description = 'Gluino production in simplified model with one-step decays, m_glu = %s GeV, m_C1 = %s GeV, m_N1 = %s GeV'%(masses['1000021'],masses['1000024'],masses['1000022'])
