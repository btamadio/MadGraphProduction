...
decay_taunu=[]
for x in xrange(342092,342097): decay_taunu.append(x)
...
extras = { 'lhe_version':'1.0',                        # These two are not present in NLO cards, 
...
build_run_card(run_card_old=get_default_runcard(isNLO=False),run_card_new='run_card.dat',nevts=nevents,rand_seed=runArgs.randomSeed,beamEnergy=beamEnergy,extras=extras)
