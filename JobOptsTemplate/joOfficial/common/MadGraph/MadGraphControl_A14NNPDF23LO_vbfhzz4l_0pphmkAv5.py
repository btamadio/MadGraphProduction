...
if options["runNumber"] not in [343253]:
  raise RuntimeError("runNumber {0:d} not recognised in these jobOptions. Available options are: 343253".format(options["runNumber"]))
...
# Generate_tf.py --ecmEnergy=13000 --firstEvent=1 --randomSeed=1 --jobConfig=MC15.343253.MadGraphPythia8EvtGen_A14NNPDF23LO_vbfhzz4l_0pphmkAv5.py --outputEVNTFile=EVNT.00001.root --runNumber=343253 --maxEvents=10
#---------------------------------------------------------------------------------------------------
