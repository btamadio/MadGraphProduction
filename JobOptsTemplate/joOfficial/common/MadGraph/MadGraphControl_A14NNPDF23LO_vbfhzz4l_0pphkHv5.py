...
if options["runNumber"] not in [343259]:
  raise RuntimeError("runNumber {0:d} not recognised in these jobOptions. Available options are: 343259".format(options["runNumber"]))
...
# Generate_tf.py --ecmEnergy=13000 --firstEvent=1 --randomSeed=1 --jobConfig=MC15.343259.MadGraphPythia8EvtGen_A14NNPDF23LO_vbfhzz4l_0pphkHv5.py --outputEVNTFile=EVNT.00001.root --runNumber=343259 --maxEvents=10
#---------------------------------------------------------------------------------------------------
